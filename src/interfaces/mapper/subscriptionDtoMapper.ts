...
import { IListAllSubResDto, IListAllSubscriptionDetailsDto } from "../dtos/SubscriptionDto";




export class SubscriptionDtoMapper {
    static toSubscrpitonList(subscription: IGetAllSubDetails): IListAllSubscriptionDetailsDto {
        return {
