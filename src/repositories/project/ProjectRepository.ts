...
import { IGetProjectByIdDto, IGetProjectResDto, IGetProjectsDto, IGetProjectsResDto, IProjectRepository } from "./interface/IProjectRepository";
        ...
        try {
            ...
            pipeline.push({
                $facet: {
                    ...
                    totalTasks: [{ $group: { _id: null, count: { $sum: "$totalTasks" } } }],
        ...
        try {
            ...
            pipeline.push({
                $project: {
                    ...
                    inReviewTasks: {
                        $ifNull: [
                            "$taskStats.inReviewTasks",
                            0
                        ]
                    },
                    totalStoryPoints: {
                        $ifNull: [
                            "$taskStats.totalStoryPoints",
                            0
                        ]
                    },
                    doneStoryPoints: {
                        $ifNull: [
                            "$taskStats.doneStoryPoints",
                            0
                        ]
                    }
                }
