...
import { IAuthResponseDto, IGithubAuthDto, IGoogleAuthDto, ILoginDto, ILogoutDto, IRefreshTokenDto, IRefreshTokenResponseDto, IRegisterDto,} from "../../../interfaces/dtos/AuthDTO";
...
export interface IAuthService {
    ...
    googleAuth(data:IGoogleAuthDto,meta:ILoginMetaDto):Promise<IAuthResponseDto>
    githubAuth(data:IGithubAuthDto,meta:ILoginMetaDto):Promise<IAuthResponseDto>
