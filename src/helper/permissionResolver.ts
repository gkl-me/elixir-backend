...
import { PERMISSION_DEPENDENCIES, WORKSPACE_PERMISSION } from "../constants/workspacePermissions";
...
export function resolveDependencies(selected: WORKSPACE_PERMISSION[]) {
...
export function removeDependents(
  ...
  const findDeps = (perm: WORKSPACE_PERMISSION) => {
